...
export function FloatingCodeCard() {
  ...
  return (
    <div className="cv-float w-full max-w-sm overflow-hidden rounded-2xl border border-[#2a313c] bg-[#0d1117] shadow-[var(--shadow-lg)]">
      ...
      <pre className="min-h-[132px] px-4 py-3 font-mono text-[13px] leading-6 text-[#e6edf3]">
        <code>
          {text}
          <span className="ml-0.5 inline-block h-4 w-2 translate-y-0.5 bg-primary/80 align-middle" />
        </code>
      </pre>
    </div>
  );
